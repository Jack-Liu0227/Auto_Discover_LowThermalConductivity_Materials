...
TEMPLATE_ROWS = [
    ...
    {"key": "postprocess_workers", "value": "2", "enabled": "1", "notes": "Bounded CPU workers for deduplication, extraction, and merge"},
    {"key": "novelty_workers", "value": "4", "enabled": "1", "notes": "Bounded workers for final database novelty queries"},
